...
const App = () => {
  ...
  return (
    <div className=" min-h-screen max-h-[100vh] max-w-[100vw] bg-gray-900 text-gray-100 flex items-center justify-center select-none">
      <div className="bg-gradient-to-b from-gray-800 to-blue-600 max-w-md mx-auto rounded-lg shadow-lg">
